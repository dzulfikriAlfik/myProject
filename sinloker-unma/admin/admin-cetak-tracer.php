...
<head>
    ...
    <title>Cetak Data Tracer Alumni | Tracer Study & Sinloker UNMA</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li>
                    <h4 style="margin-top: 5px">Cetak Data Tracer Alumni</h4>
                </li>
            </ul>
        </nav>
        <!-- /.navbar -->
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Cetak Data Tracer Alumni</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
