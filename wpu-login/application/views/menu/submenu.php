...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-2 addButtonSubmenu" data-toggle="modal" data-target="#formModal">Add New Submenu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <a href="<?= base_url('menu/subMenuEdit/') . $sm['id'] ?>" class="badge badge-pill badge-success editButtonSubmenu" data-toggle="modal" data-target="#formModal" data-id="<?= $sm['id'] ?>">edit</a>
                                <a href="<?= base_url('menu/subMenuDelete/') . $sm['id'] ?>" onclick="return confirm('Yakin?')" class="badge badge-pill badge-danger">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
