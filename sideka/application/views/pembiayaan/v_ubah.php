  ...
  <script type='text/javascript'>
      ...
      $(function(){
          $('#desa').autocomplete({
              ...
              serviceUrl: site+'datapenduduk/c_pembiayaan/cari_desa',
...
<?php echo form_open_multipart('datapenduduk/c_pembiayaan/update_pembiayaan'); ?>
	<fieldset>
		<!-- Form Name -->
		<legend></legend>
    ...
    <div class="form-group">
      ...
      <input id="id_pembiayaan" name="id_pembiayaan" type="hidden" placeholder="id_pembiayaan" class="form-control input-md" required="" value="<?= $hasil->id_pembiayaan;?>"/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="nama_rincian" name="nama_rincian" type="text" placeholder="Nama Rincian" class="form-control input-md" required="" value="<?= $hasil->nama_rincian;?>"/>
		  <span class="help-block"><?php echo form_error('nama_rincian', '<p class="field_error">','</p>')?></span>
		  </div>
		</div>

    <div class="form-group">
		  <label class="col-md-3 control-label" for="nama">Jenis Pembiayaan</label>
		  <div class="col-md-9">
		  <input id="jenis_pembiayaan" name="jenis_pembiayaan" type="text" placeholder="Jenis Pembiayaan" class="form-control input-md" required="" value="<?= $hasil->jenis_pembiayaan;?>"/>
		  <span class="help-block"><?php echo form_error('jenis_pembiayaan', '<p class="field_error">','</p>')?></span>
		  </div>
		</div>

    <div class="form-group">
		  <label class="col-md-3 control-label" for="nama">Obyek Pembiayaan</label>
		  <div class="col-md-9">
		  <input id="obyek_pembiayaan" name="obyek_pembiayaan" type="text" placeholder="Obyek Pembiayaan" class="form-control input-md" required="" value="<?= $hasil->obyek_pembiayaan;?>"/>
		  <span class="help-block"><?php echo form_error('obyek_pembiayaan', '<p class="field_error">','</p>')?></span>
		  </div>
		</div>
    ...
    <div class="form-group">
		...
		<div class="form-group">
		  ...
		  <div class="col-md-9">
			...
			<button id="batal" name="batal" class="btn btn-danger" onclick="location.href='<?= base_url() ?>datapenduduk/c_pembiayaan'">Batal</button>
		  </div>
		</div>
...
function nav_active(){
	...
	var d = document.getElementById("nav-pembiayaan");
