...
<?php echo form_open_multipart('datapenduduk/c_pembiayaan/simpan_pembiayaan'); ?>
	<fieldset>
		<!-- Form Name -->
		<legend></legend>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="jenis_pembiayaan" name="jenis_pembiayaan" type="text" placeholder="Jenis Pembiayaan" class="form-control input-md" required=""/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="obyek_pembiayaan" name="obyek_pembiayaan" type="text" placeholder="Obyek Pembiayaan" class="form-control input-md" required=""/>
