...
<?php echo form_open_multipart('datapenduduk/c_pendapatan/update_pendapatan'); ?>
	<fieldset>
		<!-- Form Name -->
		<legend></legend>
    ...
    <div class="form-group">
      ...
      <input id="id_pendapatan" name="id_pendapatan" type="hidden" placeholder="id_pendapatan" class="form-control input-md" required="" value="<?= $hasil->id_pendapatan;?>"/>
