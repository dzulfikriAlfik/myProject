...
<?php echo form_open_multipart('datapenduduk/c_data_anggaran/update_data_anggaran'); ?>
	<fieldset>
		<!-- Form Name -->
		<legend></legend>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="bidang_kegiatan" name="bidang_kegiatan" type="search" placeholder="Nama Bidang & Kegiatan" class="form-control input-md" required="" value="<?= $hasil->bidang_kegiatan; ?>"/>
      <input id="id_bidang_kegiatan" name="id_bidang_kegiatan" type="hidden" placeholder="Nama Bidang & Kegiatan" class="form-control input-md" required="" value="<?= $hasil->id_bidang_kegiatan; ?>"/>
			<input id="id_data_anggaran" name="id_data_anggaran" type="hidden" placeholder="Nama Bidang & Kegiatan" class="form-control input-md" required="" value="<?= $hasil->id_data_anggaran; ?>"/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="v_desa" name="desa" type="text" placeholder="Nama Desa" class="form-control input-md" required="" value="<?= $hasil->nama_desa; ?>" disabled/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="lokasi" name="lokasi" type="text" placeholder="Nama Lokasi" class="form-control input-md" required="" value="<?= $hasil->lokasi; ?>"/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="waktu" name="waktu" type="text" placeholder="Nama Waktu" class="form-control input-md" required="" value="<?= $hasil->waktu; ?>"/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="nama_pptkd" name="nama_pptkd" type="text" placeholder="Nama PPTKD" class="form-control input-md" required="" value="<?= $hasil->nama_pptkd; ?>"/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="pagu" name="pagu" type="text" placeholder="Pagu" class="form-control input-md" required="" value="Rp. <?= number_format($hasil->pagu,0,",","."); ?>"/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="keluaran" name="keluaran" type="text" placeholder="Keluaran" class="form-control input-md" required="" value="<?= $hasil->keluaran; ?>"/>
