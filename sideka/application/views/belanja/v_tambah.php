...
<?php echo form_open_multipart('datapenduduk/c_belanja/simpan_belanja'); ?>
	<fieldset>
		<!-- Form Name -->
		<legend></legend>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="bidang_kegiatan" name="bidang_kegiatan" type="search" placeholder="Bidang & Kegiatan" class="form-control input-md" required=""/>
      <input id="v_id_bidang_kegiatan" name="id_bidang_kegiatan" type="hidden" placeholder="ID Bidang & Kegiatan" class="form-control input-md" required=""/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="jumlah_satuan" name="jumlah_satuan" type="text" placeholder="Jumlah Satuan" class="form-control input-md" required=""/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="harga_satuan" name="harga_satuan" type="text" placeholder="Harga Satuan" class="form-control input-md" required=""/>
    ...
    <div class="form-group">
		  ...
		  <div class="col-md-9">
		  <input id="sumber_dana" name="sumber_dana" type="text" placeholder="Sumber Dana" class="form-control input-md" required=""/>
