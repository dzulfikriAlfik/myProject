...
<html>
  ...
  <body onload="window.print()">
    ...
    <h2 align="center">
      LAPORAN ANGGARAN PEMBIAYAAN <br>
      DESA <?= strtoupper($v_pembiayaan->row()->nama_desa);?>
    </h2>
    ...
    <table border="1" width="100%">
      ...
      <?php
      $no='1';
      foreach ($v_pembiayaan->result() as $baris) {?>
        <tr>
          <th><?php echo $no; ?></th>
          <th align='left'>&nbsp; <?php echo ucwords($baris->nama_rincian); ?></th>
          <th align='left'>&nbsp; <?php echo ucwords($baris->jenis_pembiayaan); ?></th>
          <th align='left'>&nbsp; <?php echo ucwords($baris->obyek_pembiayaan); ?></th>
      ...
      <tr id='foot-tr'>
        <th colspan="4" rowspan="2" align='right'> Total : &nbsp;</th>
