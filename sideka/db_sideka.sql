...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2017 at 05:58 AM
...
--
-- Table structure for table `tbl_bidang_kegiatan`
--

CREATE TABLE `tbl_bidang_kegiatan` (
  `id_bidang_kegiatan` int(10) NOT NULL,
  `id_desa` int(10) DEFAULT NULL,
  `bidang_kegiatan` text
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_bidang_kegiatan`
--

INSERT INTO `tbl_bidang_kegiatan` (`id_bidang_kegiatan`, `id_desa`, `bidang_kegiatan`) VALUES
(12, 0, 'Kegiatan Operational Kantor Desa'),
(11, 1, 'Pembayaran Penghasilan Tetap & Tunjangan');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_data_anggaran`
--

CREATE TABLE `tbl_data_anggaran` (
  `id_data_anggaran` int(10) NOT NULL,
  `id_bidang_kegiatan` int(10) DEFAULT NULL,
  `lokasi` text,
  ...
  `pagu` text,
  `keluaran` text,
  `tgl_data_anggaran` date DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_data_anggaran`
--

INSERT INTO `tbl_data_anggaran` (`id_data_anggaran`, `id_bidang_kegiatan`, `lokasi`, `waktu`, `nama_pptkd`, `pagu`, `keluaran`, `tgl_data_anggaran`) VALUES
(8, 12, 'dsfd', '10 buln', 'sfsdfg', '1000000', 'df', '2017-09-19'),
(9, 11, 'dsfdfde', '11 bulan', 'war dgfdf', '0', 'sdfkldsf', '2017-09-19'),
(13, 11, 'adjsfn', 'sdlf', 'sdlfj', '200000', 'sdfljg', '2017-09-21');
...
--
-- Dumping data for table `tbl_pembiayaan`
--

INSERT INTO `tbl_pembiayaan` (`id_pembiayaan`, `id_desa`, `nama_rincian`, `jenis_pembiayaan`, `obyek_pembiayaan`, `anggaran`, `anggaranpak`, `jumlah`, `nama_rek`, `tgl_pembiayaan`) VALUES
(2, 1, 'adsfd', 'dsfd', 'frr', '120000', '80000', '200000', 'dslfd', '2017-09-21');
...
(7, 1, 'asdfgfg', '100000', '100000', '200000', 'dfjlgn', '2017-09-21');
...
--
-- Indexes for table `tbl_bidang_kegiatan`
--
ALTER TABLE `tbl_bidang_kegiatan`
  ADD PRIMARY KEY (`id_bidang_kegiatan`);

--
-- Indexes for table `tbl_data_anggaran`
--
ALTER TABLE `tbl_data_anggaran`
  ADD PRIMARY KEY (`id_data_anggaran`);
...
--
ALTER TABLE `tbl_belanja`
  MODIFY `id_belanja` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
-- AUTO_INCREMENT for table `tbl_bidang_kegiatan`
--
ALTER TABLE `tbl_bidang_kegiatan`
  MODIFY `id_bidang_kegiatan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `tbl_data_anggaran`
--
ALTER TABLE `tbl_data_anggaran`
  MODIFY `id_data_anggaran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `tbl_pembiayaan`
  MODIFY `id_pembiayaan` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
