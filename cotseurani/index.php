...
<title>.:: Aplikasi Administras DESA::.</title>
<style>
...
#footer2 {
	background-image: url(image/green-flowers-background-6.jpg);
}
		...
		<div class="arrowgreen">
		  <div class="arrowgreen">
		    <ul>
		      ...
		      <li><a href="index.php?page=profil">Profil Desa</a></li>
		      <li><a href="index.php?page=data_penduduk">Daftar Penduduk</a></li>
		      <li><a href="index.php?page=data_kk"> Kepala Keluarga</a></li>
              <li><a href="index.php?page=lihat_kelahiran"> Data Kelahiran</a></li>
              <li><a href="index.php?page=lihat_kematian"> Info Desa</a></li>
		      <li><a href="index.php?page=download">Donwload</a></li>
		      <li><a href="index.php?page=buku_tamu">Buku Tamu</a></li>
...
function buka(id,no){
    window.open("formberita.php?userid="+id+"&no="+no,"","width=500,height=400,toolbar=0");
		...
		if ($page=="beranda") { $h2="Beranda"; }
		elseif ($page=="profil") { $h2="Profil Desa"; }
		elseif ($page=="lihat_daftar") { $h2="Daftar Nikah"; }
		elseif ($page=="data_kk") { $h2="Daftar Kepala Keluarga"; }
		elseif ($page=="lihat_kematian") { $h2="Data Kematian"; }
		elseif ($page=="lihat_kelahiran") { $h2="Data Kelahiran"; }
		elseif ($page=="download") { $h2="Halaman Download"; }
		elseif ($page=="data_penduduk") { $h2="Daftar Penduduk"; }
			elseif ($page=="registrasi") { $h2="Registrasi"; }
		elseif ($page=="buku_tamu") { $h2="Buku Tamu"; }
		elseif ($page=="daftar") { $h2="Form Pendaftaran "; }
		else { $h2="Beranda"; }
		echo "<h2>$h2</h2>";
		?>
          <div class="menu">
            <?php
		if ($page=="beranda") { include "$page.php";}
		elseif ($page=="profil") { include "$page.php";}
		elseif ($page=="lihat_kematian") { include "$page.php";}
			elseif ($page=="judul_acc") { include "$page.php";}
		elseif ($page=="dosen_penguji") { include "$page.php";}
		elseif ($page=="lihat_kelahiran") { include "$page.php";}
		elseif ($page=="download") { include "$page.php";}
		elseif ($page=="data_kk") { include "$page.php";}
		elseif ($page=="data_penduduk") { include "$page.php";}
		elseif ($page=="registrasi") { include "$page.php";}
		elseif ($page=="buku_tamu") { include "$page.php";}
		elseif ($page=="daftar") { include "$page.php";}
...
<script type="text/javascript">writeCalendar()</script>
		...
		<div class="arrowgreen">
			<ul>
			<li><a href="#" target="_blank">Kecamatan Muara Batu</a></li>
			<li><a href="#" target="_blank">Capil Aceh Utara</a></li>
			<li><a href="#" target="_blank">Pemkab Aceh Utara</a></li>
	...
	<tr>
	  <td colspan="3" id="footer2"><div align="center">Copy@Right - 2015</div></td>
    </tr>
  </table>
