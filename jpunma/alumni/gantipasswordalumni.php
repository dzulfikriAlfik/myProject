                    ...
                    <div class="col-md-10 col-md-offset-1 well" style="background-color: white">
                      <div class="x_panel">
                        ...
                        if(isset($_POST['ganti'])){
                          ...
                          $cek = mysqli_query($koneksi, "SELECT * FROM alumni WHERE npm='$npm' AND password='$password'");
                          if(mysqli_num_rows($cek) == 0){
                            ...
                            if($password1 == $password2){
                              ...
                              $pass = base64_encode(strrev(md5($password1)));
                                $update = mysqli_query($koneksi, "UPDATE alumni SET password='$pass' WHERE npm='$npm'");
                                if($update){
