        ...
        <div class="row" style="background-color: white">
          ...
          <div class="row">
            ...
            if($result1->num_rows > 0 ) {
              ?>
              <center><a href="lamarlowongan.php" class="btn btn-danger btn-lg"><strong>sudah di lamar</strong></a></center>
              <?php  
            } else {
            ?>

            <center>
              <a href="lamarjob.php?id=<?php echo $row['id_job']; ?>" class="btn btn-success btn-lg">Lamar</a>
            </center>
            <?php } ?>
