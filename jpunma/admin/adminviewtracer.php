      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main" style="background-color: ">
          <div class="row">
                          ...
                          <!-- koneksi database -->
                          <?php  
                           $sql = "SELECT * FROM kuesioner WHERE id_label='$_GET[id]'";
            ...
            <div class="col-md-12 col-md-offset well" style="background-color: white">
              <div class="col-md-12 col-md-offset">
                  <div class="x_panel">
                    <div class="x_title">
                      <h2>Hasil Quesioner Tracer Study <?php echo $row['dp_nama']; ?></h2>
                      <h2 class="col-md-12">
...
<!-- --------------------------------------------------------------------KUESIONER LANJUTAN -------------------------------------------------- -->
                            ...
                            <h4><b>2. Saran <?php echo $row['dp_nama']; ?> Untuk Unviversitas :</b></h4>
                              <div class="col-md-12 col-md-offset">
