        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <!-- tabel lowongan -->
              ...
              <?php if(isset($_SESSION['tracerDeletedSuccess'])) { ?>
              <div class="col-md-12 col-md-offset">
                <div class="alert alert-danger">
                  <h2><center>Data Tracer Alumni Berhasil dihapus !!!</center></h2> 
                </div>
              </div>
              <?php unset($_SESSION['tracerDeletedSuccess']); } ?>
              <!-- menampilkan hasil Hapus job -->
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <!-- endkoneksi -->
                        <tr>
                          <td class="text-center"><?php echo $row['dp_nama']; ?></td>
                          <td class="text-center"><?php echo $row['dp_npm']; ?></td>
                          <td class="text-center"><?php echo $row['dp_jurusan']; ?></i></td>
                          <td class="text-center"><?php echo $row['dp_tahunmasuk']; ?></i></td>
                          <td class="text-center"><?php echo $row['dp_tahunlulus']; ?></i></td>
                          <td class="text-center">
                            <a href="adminviewtracer.php?id=<?php echo $row['id_label']; ?>">Lihat detail&nbsp;&nbsp;|</a>
                            <a onclick="return confirm('Apakah Anda Yakin Untuk Menghapus Data Ini?')" href="hapustracer.php?id=<?php echo $row['id_label']; ?>" style="color: red">&nbsp;Hapus</a>
                          </td>
                        <?php
                            }
                          }
