      ...
      <div class="main_container">
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_info">
                ...
                <h2><?php echo $_SESSION['namacompany']; ?></h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
        ...
        <div class="row" style="background-color: white">
          ...
          <div class="col-md-12 well alert alert-success">
            ...
            <h3 class="text-center"><?php echo $_SESSION['namacompany']; ?></h3>
          ...
          <div class="row">
            <div class="col-md-6 col-md-offset-1">
              <p></p>
              <h3 class="fa fa-briefcase" style="font-size: 230%;color: black">&nbsp;&nbsp;Deskripsi Pekerjaan </h3>
            </div>
            ...
            <div class="col-md-1 col-md-offset-1">
              <h3 class="fa fa-book" style="font-size: 230%;color: black">&nbsp;&nbsp;Persyaratan</h3>
            </div>
            <div class="col-md-12 col-md-offset-1">
          ...
          <center>
            <h5 style="color: black">Diiklankan sejak :
