...
class M_penjadwalan extends CI_Model{
	...
	function delete_by_kode_dosen($kode_dosen){
        $this->db->query("DELETE FROM penjadwalan WHERE kode_dosen='$kode_dosen'");
    }
	
	function delete_by_mk($kode_mk){
		$this->db->query("DELETE FROM penjadwalan WHERE kode_mk = '$kode_mk'");
	}
	
	function delete($kode){
		$this->db->query("DELETE FROM penjadwalan WHERE kode = '$kode'");		
	}
