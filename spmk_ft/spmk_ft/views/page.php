...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>spmk.ft.unma.ac.id | Sistem Penjadwalan Mata Kuliah Fakultas Teknik Universitas Majalengka </title>
		...
		function ShowProgressAnimation(){
		 ...
		 function change_get(){		
			...
			var tahun_akademik = document.getElementById('tahun_akademik');
		 	window.location.href = "<?php echo base_url().'web/jadwal/' ?>" + semester_tipe.options[semester_tipe.selectedIndex].value  + "/"	  + tahun_akademik.options[tahun_akademik.selectedIndex].value;		
		 }
               ...
               <body class="">
                  <div class="navbar">                 	
                     <div class="navbar-inner">
                        <a class="brand" style="padding-top: 30px"><span class="second">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Sistem Penjadwalan Mata Kuliah Fakultas Teknik Universitas Majalengka</span>
                        <a class="brand" style="padding-top: 60px">
                        </a>
                     </div>
                  </div>
                  <div class="sidebar-nav" style="padding-top: 5px">				 
                     <a href="<?php echo base_url()?>web/dashboard" class="nav-header"><i class="icon-home"></i>Dashboard</a>
                     ...
                     <ul id="content-menu" class="nav nav-list collapse in">
						...
						<li><a href="<?php echo base_url();?>web/jadwal"><i class="icon-th-list"></i>Jadwal</a></li>   
						<li><a href="<?php echo base_url()?>web/ruang"><i class="icon-home"></i>Ruang</a></li>
						<li><a href="<?php echo base_url()?>web/jam"><i class="icon-time"></i>Waktu</a></li>
                     ...
                     <ul id="content-menu" class="nav nav-list collapse in">                        
						<li><a href="<?php echo base_url();?>web/penjadwalan"><i class="icon-th-list"></i>Ploting Jadwal</a></li>
					 </ul>	
                  </div>
