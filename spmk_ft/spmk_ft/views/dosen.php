<div class="content">
   ...
   <div class="container-fluid">
      ...
      <div class="row-fluid">
        <a href="<?php echo base_url() . 'web/dosen_add';?>"> <button class="btn btn-primary pull-right"><i class="icon-plus"></i> Tambah Data Dosen</button></a>     
        ...
        <form class="form-inline" method="POST" action="<?php echo base_url() . 'web/dosen_search'?>">
          ...
          <a href="<?php echo base_url() . 'web/dosen';?>"><button type="button" class="btn">Reset</button> </a>
        </form>
