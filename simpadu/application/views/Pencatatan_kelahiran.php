                                        ...
                                        foreach($penduduks as $penduduk){
                                            ?>
                                                <tr>
                                                    ...
                                                    <td> <button class="btn btn-primary btn-sm"> <span class="fa fa-pencil fa-fw"></span> </button> ||
                                                    <button class="btn btn-primary btn-sm"><span class="fa fa-trash fa-fw"></span> </button> </td>
                                                </tr>
                                            <?php
                                            $no++;
                                        }
